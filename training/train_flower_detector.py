"""Train Model B: Flower detector for triggering Cam-B burst capture.

Uses YOLOv8n pretrained weights, fine-tuned on flower/bud detection dataset.
Saves best.pt to models/flower_detector_v1.pt.

Usage:
    python training/train_flower_detector.py
    python training/train_flower_detector.py --epochs 50 --batch 32
"""
...
CONFIG_PATH = PROJECT_ROOT / "training" / "configs" / "flower_detector.yaml"
DATASET_DIR = PROJECT_ROOT / "training" / "datasets" / "flower"
OUTPUT_MODEL = PROJECT_ROOT / "models" / "flower_detector_v1.pt"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train flower detector")
